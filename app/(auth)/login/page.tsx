...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // In a real app, you might use httpOnly cookies or session storage
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
